$(document).ready(function() {
    ...
    $('.bt').click(function() {
        ...
        if (clicked_pokemon === pokemon_name["correct"]) {
            ...
            $('#final_score').html('Your Score: <b>' + score + '</b>');
            $('#content').hide();
            $('#game_over').show();
        }
    });
...
var generate_random_image = function(difficulty) {
    ...
    var difficulty_value = 151;

    if (difficulty === "gen1") {
        difficulty_value = 151;
    } else if (difficulty === "gen2") {
        difficulty_value = 251;
    } else if (difficulty === "gen3") {
        difficulty_value = 386;
    } else if (difficulty === "gen4") {
        difficulty_value = 493;
    } else if (difficulty === "gen5") {
        difficulty_value = 649;
    } else if (difficulty === "gen6") {
        difficulty_value = 720;
    }
